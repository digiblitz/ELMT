...
public class OnlineEntriesCalendarAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm  form,
        ...
        try{
           ...
           if(cmd!=null && cmd.equalsIgnoreCase("initCalendarList")){
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("viewList")){
                ...
                if(year!=0){
                    organizerList = calRemote.getOrganizerList(year, acStatus, organizerId);
                }
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("singleEventView")){
                ...
                if(provisionalId!=null && provisionalId.trim().length()!=0){
                    calVO = calRemote.getSingleEventDetails(provisionalId);
                }
                request.setAttribute("singleEventDetails",calVO);
                return mapping.findForward("singleEventView");
            }
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("singleEventApprove")){
                ...
                request.setAttribute("singleEventDetails",calVO);
                return mapping.findForward("singleEventApprove");
            }
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("approveOrgDetails")){
                ...
                if(provisionalId!=null && provisionalId.trim().length()!=0 && orgStatus!=null && orgStatus.trim().length()!=0){
                    result = calRemote.approveSingleEventDetails(provisionalId, orgStatus, orgComments);
                }
                
               if(result){
                   ArrayList eveStatList = calRemote.getEventDetsApprovedByAll(provisionalId,eventId);
          ...
          if(orgApprovStat!=null && orgApprovStat.equalsIgnoreCase("Approved") && areaChApprovStat!=null && areaChApprovStat.equalsIgnoreCase("Approved") && uStaffApprovStat!=null && uStaffApprovStat.equalsIgnoreCase("Approved") && oldEventId!=null && eventId!=null){
              boolean output=calRemote.eveDetailsExistsInEveTable(eventId);
              Debug.print("output:" +output);
              if(output==false){
              ArrayList eveStatList1 = calRemote.getOldEventDetails(oldEventId);
              ArrayList eveStatList2 = calRemote.getOldEventHistoryDetails(oldEventId);
           ...
           if(compZip!=null){
            ...
            if(userId!=null && userId.trim().length()!=0){
             ...
             resultStat=calRemote.insertProCalEveIntoEveDetails(objEventDetails);
          ...
          if(eveStatList2!=null && eveStatList2.size()!=0){                  
           ...
           if(eveTitle!=null){
            objEventDetails.setEventTitle(eveTitle);
             ...
             resultHistStat=calRemote.insertProCalEveIntoEveHistoryDetails(objEventDetails);
            ...
            if(resultStat==true){
             provDets=calRemote.getProvEventDetails(eventId);
            }
            if(provDets!=null && provDets.size()!=0){
             ...
             boolean resultStat1=calRemote.updateNewEveDets(orgId,eveTitle,eveBegDt,eveEndDt,oeBegDt,oeEndDt,oeExDueDt,state,area,eventId);
             boolean resultStat2=calRemote.updateOmnibusDetsInAllTables(eventId,oldEventId);
       ...
       boolean output1=calRemote.eveDetailsExistsInEveTable(eventId);
              Debug.print("output1:" +output1);  
        if(output1==false){ 
    ArrayList eveList = calRemote.getApprovedEventDet(provisionalId,eventId); 
          ...
          if(orgId!=null){
           ...
           if(StaId!=null){
            ...
            proEveObj.setIssueId(eveIssId);
             ...
             boolean eveResult=calRemote.insertEveDetails(proEveObj);  
             
             
          if(eveResult==true){
              
        ArrayList eveTypLevelsList=calRemote.getEveTyLevIdDet(provisionalId,eventId);
          ...
          if(eveTypLevelsList!=null && eveTypLevelsList.size()!=0){
            ...
            String mapTypeId=calRemote.getEveTypLevelMapId(eveTypeId,eveLevId);
            
           boolean mapResult=calRemote.insertMapDets(eventId,mapTypeId);
            Debug.print("mapResult *****" +mapResult);             
                ...
                if(result){
                    ...
                    return mapping.findForward("singleEventApproveSuccess");
                }else{
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("initACList")){
                return mapping.findForward("acList");
            }
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("viewACList")){
                ...
                if(year!=0){
                    areaChairList = calRemote.getAreaChairList(year, acStatus, acId);
                }
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("areaChairView")){
                ...
                request.setAttribute("singleEventDetails",calVO);
                return mapping.findForward("areaChairView");                
            }
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("areaChairApprove")){
                ...
                request.setAttribute("singleEventDetails",calVO);
                return mapping.findForward("areaChairApprove");
            }
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("approveAreaChairDetails")){
                ...
                if(provisionalId!=null && provisionalId.trim().length()!=0 && acStatus!=null && acStatus.trim().length()!=0){
                    result = calRemote.approveAreaChairDetails(provisionalId, acStatus, acComments);
                }
                if(result){
                   ArrayList eveStatList = calRemote.getEventDetsApprovedByAll(provisionalId,eventId);
                    String areaChApprovStat="";
          ...
          if(eveTypLevelsList!=null && eveTypLevelsList.size()!=0){
           ...
           boolean mapResult=calRemote.insertMapDets(eventId,mapTypeId);
            Debug.print("mapResult *****" +mapResult);             
                ...
                if(result){
                    request.setAttribute("approveStatus","approveSuccess");
                    return mapping.findForward("areaChairApproveSuccess");
                }else{
                    request.setAttribute("approveStatus","approveFailed");
                    return mapping.findForward("areaChairApproveSuccess");
                }
