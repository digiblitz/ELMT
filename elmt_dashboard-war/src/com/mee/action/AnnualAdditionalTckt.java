...
public class AnnualAdditionalTckt extends Action {
...
// Update Pending Amount Refund Feasibility        
...
// Refund Feasibility       
        ...
        if(execute!=null && execute.trim().length()!=0){
            if(execute.trim().equalsIgnoreCase("addTckt")){
                ...
                return mapping.findForward("addTcktpge");
            }
                ...
                if(r11.equals("card")){
                    ...
                    if(tktactivityId!=null){
                        if(tktactivityId!=null || tktactivityId.trim().length()!=0){
                            ...
                            HLCAccTxnTypeDetailVO accTxnDet = mahaRemote.selectAccTransactionTypeDetail(tktactivityId);
...
//                    intVId = 1;
 //               }
               ...
               //     Debug.print("Sucessfully Payment objPaymentList:" + objPayment.toString());
                    ...
                    String meetingId = vaiRemote.registerAdditionalTickets(tcktVO);
                        ...
                        logBy=loggedBy;
                            ...
                            if(chckAmount!=null && totalAmount1!=null){
                                ...
                                if(chckAmount.trim().length()!=0 && totalAmount1.trim().length()!=0){
                                    ...
                                    if(extraAmt > 0){
                                        boolean update_refund = remote.updatePendingAmount(userId,paymentId,chkAmt);
                                    ...
                                    if(extraAmt >= 0){
                                        ...
                                        boolean status_Change = vaiRemote.updateAnnualStatus(meetingId,"Active","HLC Staff Activation");
       ...
       private HLCVaigaiSessionRemote initializeVaigaiEJB(HttpServletRequest request) throws Exception{
        ...
        javax.rmi.PortableRemoteObject.narrow(objref,HLCKaveryMembershipTypeSessionRemoteHome.class);
