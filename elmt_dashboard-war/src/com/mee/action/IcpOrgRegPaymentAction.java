...
public class IcpOrgRegPaymentAction extends Action {
    ...
    /** Creates a new instance of MagazineOminibus */
     public ActionForward execute(ActionMapping mapping, ActionForm  form,
       ...
       try{
            ...
            String jndiname2=mr.getMessage("jndi.icp");
            ...
            javax.rmi.PortableRemoteObject.narrow(objref2,HLCVaigaiSessionRemoteHome.class);
            ...
            Debug.print("Sucessfully Return objPaymentList:" + objPayment.toString());
              if(sslResult.equals("0")){
                   ...
                   String pymtId = remote.getPaymtId();
                  ...
                  //  objPayment.setPaymentId(pymtId);
                   ...
                   // objPayDet.setCcNumber(objPayment.getCcNumber());
                    ...
                    if(objInstDetail!=null){
                         ...
                         bol = remote.addInstructorDetails(objInstDetail,objPayment);
                    ...
                    if(resultPay == true && bol==true){
                        ...
                        return mapping.findForward("IcpOrgRegConfirm");
                    }
                 }
              }
              else{
