...
public class ActionICPEdit extends Action {
            ...
            * Service Locator for ejb/HLCVaigaiSessionJNDI
            ...
            HttpSession session=request.getSession();
             ...
             if(process.equalsIgnoreCase("edit")) {
                    ...
                    dispReg=remote.displayICPRegBasedOnMeetingId(icpMeetingId);
              ...
              */
                ...
                if(process.equalsIgnoreCase("update"))
                {
                    ...
                    //objInstDetail.setAddDate(new Date());
                    ...
                    boolean bol = remote.editInstructorDetails(objInstDetail);
                    Debug.print("Result of update ActionICPEdit"+bol);
                    fwd="IcpOrgRegConfirm";
