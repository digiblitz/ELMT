...
public class IcpOrgRegAction extends Action {
 ...
 JNDI
            ...
            System.out.println("\n after InitialContext inside icp org reg list action...\n");
                ...
                if(process.equalsIgnoreCase("disp")) {
                    ...
                    area = remote.displayUseaArea();
                    request.setAttribute("area",area);
                    return mapping.findForward("IcpOrgRegDisp");
                }
           ...
           Debug.print("payment status:" + payment);
             if(payment.equals("card")){
               ...
               if(expMon.trim().length()==1) {
                ...
                return mapping.findForward("successInsertRedirIcp");
             }
            else{
