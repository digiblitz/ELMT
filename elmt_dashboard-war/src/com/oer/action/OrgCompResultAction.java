 ...
 * @version
 */
public class OrgCompResultAction extends Action {
        ...
        try{
            ...
            if(cmd!=null){
                ...
                if(cmd.equals("initList")){
                    ...
                    return mapping.findForward("frmOEROrgCompResList");
                }
                ...
                if(cmd.equals("initEventTypeList")){
                    ...
                    eventType=qremote.getEventTypes(eventId);
                ...
                if(cmd.equals("listDetails")){
                    ...
                    eventType=qremote.getEventTypes(eventId);
                    eventTitles=qremote.getEventTiles(year,organizerId);
                    eventcompResLabel=qremote.getOrgCompResLabelList(eventTypeId);
                    eventcompResDetails=qremote.getOrgCompResList(Integer.parseInt(year),eventId,eventTypeName,organizerId);
                ...
                if(cmd.equals("insertResultDetails")){
                    ...
                    for(int i=1; i<=resSize; i++){
                        ...
                        String eventLevelId=qremote.getEventLevelId(eventLevel);
                        String division=request.getParameter("division"+i);
                        String eventDivisionId=qremote.getEventDivId(division);
                        ...
                        isexist=qremote.isCompResExist(tempYear,eveId,horseMemberId,riderUserId);
                        if(isexist==true){
                        request.setAttribute("AlreadyExist","AlreadyExist");
                        return mapping.findForward("frmOEROrgCompResList");
                        }else{
                        result=qremote.insertCompResultDetails(compVO);
                        }
                        if(result==true){
                        flag=true;    
                        }else{
