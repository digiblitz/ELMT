...
public class AdminRefundOverpay extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm  form, HttpServletRequest request, 
            ...
            try{
                ...
                Object obj=jndiContext.lookup(refundname);
                
                HLCRefundSessionRemoteHome refundHome = (HLCRefundSessionRemoteHome)
                javax.rmi.PortableRemoteObject.narrow(obj,HLCRefundSessionRemoteHome.class);
                HLCRefundSessionRemote refundRemote = refundHome.create();
