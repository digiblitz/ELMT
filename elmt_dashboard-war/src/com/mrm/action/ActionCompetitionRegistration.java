...
public class ActionCompetitionRegistration extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm  form,
        ...
        //String fwd="resultConf";
        
        try{
            Debug.print("ActionCompetitionRegistration calling");
            ...
            if(process==null || process.trim().length()==0){
                ...
                if(upId!=null && upId.trim().length()!=0){
                    ArrayList exceptionList = (ArrayList)remote.getExceptionReport(upId);
                ...
                return mapping.findForward("frmCompRegException");
                ...
                boolean result = remote.validateHorseCompReg(valHrList);
                Debug.print("Final Result:" + result);
                if(result =true && uploadId!=null && uploadId.trim().length()!=0){
                    boolean uploadResult = remote.updateValidationStatus(uploadId);
                ...
                if(upId!=null && upId.trim().length()!=0){
                    ArrayList exceptionList = (ArrayList)remote.getExceptionReportForResult(upId);
                    String eventTitle = remote.getEventTitle(upId,eventId);
                ...
                return mapping.findForward("resultException");
            }
                ...
                for(int i=1; i<=rCount; i++){
                    ...
                    String eventDetailId[]=remote.getEventIds(eventType,eventLevel,event_division);
                   ...
                   if(to_date_points.equalsIgnoreCase("null") || to_date_points==""){
                    ...
                    if(tmpHorseId.equalsIgnoreCase("CAN") ||  tmpRiderId.equalsIgnoreCase("CAN") || tmpHorseId.equalsIgnoreCase("NR") ||  tmpRiderId.equalsIgnoreCase("NR")){
                        Debug.print("Inside compRegVO.setExceptionStatus(true) block ");
                        compRegVO.setExceptionStatus(true);
                        //boolean result = remote.insertInvalidHorseCompResult(compRegVO);
                         result1 = remote.insertValidHorseCompResult(compRegVO);
                        Debug.print("remote.insertInvalidHorseCompResult(compRegVO) result :" + result1);                        
                    
                    }
                    else {
                         result1 = remote.insertValidHorseCompResult(compRegVO);
                        Debug.print("remote.insertValidHorseCompResult(compRegVO) result :" + result1);
                    }                   
           ...
           // code starts here for Starter Count
               ...
               if(result1==true){                   
                     ...
                     String resGroupId = "";                     
                     starterList = remote.getCompResultStarterCount(eventId,uploadId);
                 ...
                 //Debug.print("inside tempStartCnt0.length() tempStartCnt0.length()"+tempStartCnt0.length());
                    starterDetList = remote.getCompResultTempResIds(eventId,tmpMergDiv,uploadId);                  
                    Debug.print("starterDetList size in servlet for 0 :" + starterDetList.size());
                    if(tmpeveDiv!=null && tmpeveDiv.trim().length()!=0){
                     eveDivisionId=remote.getEventDivisionId(tmpeveDiv);                    
                    }
                    ...
                    if(tmpEveLevel!=null && tmpEveLevel.trim().length()!=0){
                     eveLevelId=remote.getEventLevelId(tmpEveLevel);                    
                    }
                    ...
                    String resultId0="";                                  
                    resGroupId = remote.getCompResultGroupId(eventId,starterDetList,tempStartCnt0,eveDivisionId,tmpSubDiv,eventTypeId,uploadId,eveLevelId);
                    ...
                    if(starterDetList!=null && starterDetList.size()!=0){ 
                        ...
                        boolean output1 = remote.updateCompResultGrpDets(eventId,resultId0,resGroupId);
                ...
                //Debug.print("inside tempStCnt1.length()"+tempStCnt1);
                    starterDetList = remote.getCompResultTempResIds(eventId,tmpMergDiv1,uploadId);                  
                    ...
                    eveDivisionId1=remote.getEventDivisionId(tmpeveDiv1);
                    ...
                    if(tmpeveLeve11!=null && tmpeveLeve11.trim().length()!=0){
                     eveLevelId1=remote.getEventLevelId(tmpeveLeve11);
                    }
                   ...
                   // Debug.print("eveLevelId1 for startCnt k<tmpLength:" + eveLevelId1);
                    ...
                    String eveDiv1="";
                    String stCnt1=""; 
                    resGroupId = remote.getCompResultGroupId(eventId,starterDetList,tempStCnt1,eveDivisionId1,tmpSubDiv1,eventTypeId,uploadId,eveLevelId1);
                    ...
                    if(starterDetList!=null && starterDetList.size()!=0){ 
                        ...
                        boolean output1 = remote.updateCompResultGrpDets(eventId,resultId1,resGroupId);
                ...
                if(uploadId!=null && uploadId.trim().length()!=0){
                    boolean uploadResult = remote.updateResultValidationStatus(uploadId);
                    Debug.print("Update upload Result:" + uploadResult);
                }
 
               return mapping.findForward("resultConf");
            }
