...
public class MembershipRegInsertAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm  form,
        ...
        HLCKaverySessionBeanStatfulRemoteHome kaveryHome = (HLCKaverySessionBeanStatfulRemoteHome)
        javax.rmi.PortableRemoteObject.narrow(objref3,HLCKaverySessionBeanStatfulRemoteHome.class);
      ...
      /*  if(!donAmtSel.equals("0"))
        {
         if(donAmtSel.equalsIgnoreCase("Others"))
         {
             donAmt=request.getParameter("otherdon");
         }
         else
         {
            donAmt=donAmtSel;
