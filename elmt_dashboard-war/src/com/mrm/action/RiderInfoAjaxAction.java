...
public class RiderInfoAjaxAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm  form,
      ...
      //set the content type 
        ...
        response.setHeader("Cache-Control", "no-cache"); 
         ...
         String Myname = "ejb/HLCMemberRegistrationJNDI";
       ...
       /* //get parameters store into the hashmap 
        ...
        String rid= (String)paramsMap.get("rid"); */
         ...
         try {   
                     ...
                     Object objref = jndiContext.lookup("ejb/HLCKaverySessionStatefulBean");
                     ...
                     /*
                      * ejb/HLCMemberRegistrationJNDI bean lookup for email status
                      */ 
                     
                     Object obj=jndiContext.lookup(Myname);
                     HLCkaverystatelessRemoteHome usrhome =
                     (HLCkaverystatelessRemoteHome) PortableRemoteObject.narrow(obj, HLCkaverystatelessRemoteHome.class);
                     HLCkaverystatelessRemote usrremote = usrhome.create();
