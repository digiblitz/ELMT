...
import com.mrm.actionform.UploadRegDataActionForm;
...
public class UploadRegDataAction extends Action {
    String fwd=""  ;
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm  form,
        ...
        try {
            ...
            String vaigainame=mr.getMessage("jndi.vaigaisless");
            Object vaigairef = jndiContext.lookup(vaigainame);
            HLCVaigaiStatelessRemoteHome vaigaiHome =(HLCVaigaiStatelessRemoteHome)
            javax.rmi.PortableRemoteObject.narrow(vaigairef, HLCVaigaiStatelessRemoteHome.class);
            ...
            UploadRegDataActionForm  uploadRegForm = (UploadRegDataActionForm)form;
            ...
            if(process!=null && process.trim().length()!=0){
                ...
                if(process!=null && process.equalsIgnoreCase("viewUpload")) {
                    ...
                    return mapping.findForward("viewUpload");
                }
                
                if(process.equalsIgnoreCase("upload")) {
                    //upload the  file
                    
                    String directoryTemp=mr.getMessage("horseReg_uploadPath");
                    String fullFilePath = "";
                    ...
                    try {
                        ...
                        regUploadId = remote.createHorseRegUploadDetails(eventId,eventType,fullFilePath);
                        System.out.print("Upload Id in UploadRegDataAction" + regUploadId);
                        Debug.print("remote.createHorseRegUploadDetails(eventId,fullFilePath) uploadId :"+regUploadId);
                    ...
                    if(regUploadId!=null){
                        ...
                        return mapping.findForward("uploadConf");
                    } else{
                ...
                if(process.equalsIgnoreCase("listUploadDetails")) {
                    ...
                    compFileDetails = remote.getUploadHorseRegDetails();
                    ...
                    return mapping.findForward("listUploadDetails");
                }
                ...
                if(process.equalsIgnoreCase("dispDataMapping")) {
                    ...
                    if(butName!=null && butName.equalsIgnoreCase("map")){
                        ...
                        try {
                            ...
                            tblDetails = remote.getHorseRegMappingTableDetails();
                            ...
                            //request.setAttribute("excelRows",excel);
                            return mapping.findForward("mapColumns");
                            
                        }
                        catch(Exception e) {
                            Debug.print("Exception while retrieving data frm Excel :"+e);
                            return mapping.findForward("formatInfo");
                        }
                    }
                     /*
                      * Delete block.............
                   ...
                   if(butName!=null && butName.equalsIgnoreCase("Delete")){
                        ...
                        try {
                            ...
                            boolean stat1 = remote.deleteCompRegDetails(regUploadId);
                            Debug.print("deleteCompRegDetails(eventId) status in servlet :"+stat1);
                            boolean stat2 = remote.deleteCompRegMappedDatas(regUploadId);
                            Debug.print("deleteCompResultMappedDatas(uploadId) status in servlet :"+stat2);
                            boolean stat = remote.deleteCompRegFileDetails(regUploadId);
                        ...
                        return mapping.findForward("delConf");
                    }
                }
                ...
                try {
                    ...
                    for(int k=0;k<excelRows.size();k++) {
                     ...
                     /*   if(dropValue[12] != null && dropValue[12].trim().length()!=0) {
                        ...
                        status = remote.createHorseRegMapData(HLCCompResultVO);
                        Debug.print("remote.insertCompMapData(HLCCompResultVO) row count "+k+" status :"+status);
                        
                    }
                    if(status==true){
                        boolean stat = remote.changeMapStatus(regUploadId);
                        Debug.print("changeEventMapStatus(uploadId) :"+stat);
                        return mapping.findForward("mappingConf");
                    }
                    ...
                    e.printStackTrace();
                    boolean stat2 = remote.deleteCompRegMappedDatas(regUploadId);
                    return mapping.findForward("mappingError");
                }
            }
   }
    } catch(Exception e) {
