/*
 * AdminChangeHorseNovaAction.java
 *
 * Created on February 27, 2007, 10:38 AM
 */
...
public class AdminChangeHorseNovaAction extends Action {
...
///Transaction Entry
            ...
            Debug.print("competitionName in Nova Action::" +competitionName);
            ...
            if(userId!=null){
                    ...
                    //PaymentVO objPayDet = (PaymentVO)session.getAttribute("objPaymentList");       
            ...
            if(objPayDetail!=null && tempPendAmount>0 && sslResult.equals("0")){
                      ...
                      boolean statusChange = remote.updateBalanaceAmount(paymentId,0);
              ...
              if(sslResult.equals("0")) {
                    if(update_stat == true || create_stat == true){
                        boolean statusChange = remote.updateBalanaceAmount(paymentId,0);
                        Debug.print(" updateBalanaceAmount for Credit Card:" + statusChange);
