/*
 * HorseMembRenewPayAction.java
 *
 * Created on October 14, 2006, 10:27 PM
 */
 ...
 * @author suresh
 */
public class HorseMembRenewPayAction extends Action {
     ...
     public ActionForward execute(ActionMapping mapping, ActionForm  form,
       ...
       try{
            ...
            HLCPaymentSessionRemote objPaySessRemote = objPaySessHome.create();
             ...
             javax.rmi.PortableRemoteObject.narrow(objref2,HLCKaverySessionBeanStatfulRemoteHome.class);
            ...
            Debug.print("Sucessfully Return objPaymentList:" + objPayment.toString());
              if(sslResult.equals("0")){
                 ...
                 if(objPayment!=null){
                    ...
                    objPayDet.setCcNumber(String.valueOf(objPayment.getCcNumber()));
                     ...
                     if(resultPay == true)
                    {
                        ...
                        objHorseDesc=(HLCHorseDescription)session.getAttribute("objHorseDesc");
                        
                        if(objHorseDesc!=null)
                        {
                ...
                Debug.print("Not Inserted:");
                 ...
                 // sharma roll back method
                 // remote.deletePaymentDet(membId);
