...
public class EventEntryValidationAction extends Action {
        ...
        try{
            ...
            if(cmd!=null && cmd.equalsIgnoreCase("initValidation")){
                ...
                if(eventId!=null && eventId.trim().length()!=0 ){
                    selectEventDetails=calRemote.searchEventDetailsListAdmin(eventId,null,null,cYear);
                }
                ...
                horseDetails = qremote.getHorseMemberValidationDetails(horseMemberId, divisionId);
                riderDetails = qremote.getRiderDetails(riderId, divisionId);
                userDetails = calRemote.getUserTypes();
                ...
                if(eventId!=null && eventId.trim().length()!=0 ){
                    selectEventDetails=calRemote.searchEventDetailsListAdmin(eventId,null,null,Integer.parseInt(cmpYear));
                }
                ...
                if(horseUserTypeId!=null && horseUserTypeId.trim().length()!=0){
                    horseValidationDetails = qremote.getQualificationDetails(eventTypeId, eventLevelId, chStat, horseUserTypeId, divisionId);
                    if(horseDetails!=null && horseDetails.size()!=0){
                        ...
                        while(itr.hasNext()){
                            ...
                            horseRecordCount = qremote.getRecordCountForHorse(qualificationPeriod, dateToValidate, horseMemberId);
                ...
                if(riderUserTypeId!=null && riderUserTypeId.trim().length()!=0){
                    riderValidationDetails = qremote.getQualificationDetails(eventTypeId, eventLevelId, chStat, riderUserTypeId, divisionId);
                    if(riderDetails!=null && riderDetails.size()!=0){
                        ...
                        while(itr.hasNext()){
                            ...
                            String dateToValidate = sdf.format(qualifyDate);
                            riderRecordCount = qremote.getRecordCountForRider(qualificationPeriod, dateToValidate, riderId);
                ...
                eventTypeDetails = qremote.getEventTypeDetails(eventId);
                String eventLevelName = qremote.getEventLevelName(eventLevelId);
                String eventTypeName = qremote.getEventTypeName(eventTypeId);
                ...
                if(horseDetails.size()!=0 && riderDetails.size()!=0){
                    if(horseFlag==horseInt && riderFlag==riderInt) return mapping.findForward("toPayment");
                    else return mapping.findForward("validatedResult");
                }else{
                    return mapping.findForward("viewValidatedResult");
                }
            }
                ...
                if(redir!=null && redir.equalsIgnoreCase("horse")) return mapping.findForward("selAnotherHorse");
                else if(redir!=null && redir.equalsIgnoreCase("payment")) return mapping.findForward("toFinalPayment");
            }
        } catch(Exception e){
            e.printStackTrace();
        }
    ...
    public String[] getFinalEventResults(String horseMemberId, String riderId, String eTId, String eLId, String eTName,
        ...
        try{
            ...
            if(horseUserTypeId!=null && horseUserTypeId.trim().length()!=0){
                ArrayList horseValidationDetails = qremote.getQualificationDetails(eTId, eLId, chStatus, horseUserTypeId, divisionId);
                if(horseDetails!=null && horseDetails.size()!=0){
                    Iterator itr = horseDetails.iterator();
                    while(itr.hasNext()){
                        String hDet[] = (String[])itr.next();
            ...
            if(riderUserTypeId!=null && riderUserTypeId.trim().length()!=0){
                ArrayList riderValidationDetails = qremote.getQualificationDetails(eTId, eLId, chStatus, riderUserTypeId, divisionId);
                if(riderDetails!=null && riderDetails.size()!=0){
                    Iterator itr = riderDetails.iterator();
                    while(itr.hasNext()){
                        String hDet[] = (String[])itr.next();
