...
public class EventReports extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (process != null) {
            if (process.equalsIgnoreCase("eventsYearWise")) {
                ...
                ArrayList yearlyEvents = remote.getEventsConductedYearWise(fromYear, toYear);
                if (view.equalsIgnoreCase("1")) {
                    ...
                    return mapping.findForward("eventsYearWise");
                } else {
                    ...
                    return mapping.findForward("eventsYearWiseTabular");
                }
                ...
                String graphNew = request.getParameter("graph");
                String graph[] = graphNew.split(",");
                ArrayList areaWiseEvents = remote.getEventsConductedAreaWise(startDate, endDate);
                if (view.equalsIgnoreCase("1")) {
                    for (int i = 0; i < graph.length; i++) {
                    ...
                    return mapping.findForward("eventsAreaWiseTabular");
                }
            }
                ...
                String graphNew = request.getParameter("graph");
                String graph[] = graphNew.split(",");
                ArrayList typeWiseEvents = remote.getEventsConductedTypeWise(startDate, endDate);
                /*for(int i=0;i<typeWiseEvents.size();i++)
                {
                HashMap typeWise=(HashMap)typeWiseEvents.get(i);
                Set type=typeWise.keySet();
                for(Iterator it=type.iterator();it.hasNext();)
                {
                String type_Name=(String)it.next();
                Double db=(Double)typeWise.get(type_Name);
                Debug.print("Event Type Name is:"+type_Name+"  Count is "+db.doubleValue());
                }
                }*/
                 if (view.equalsIgnoreCase("1")) {
                    for (int i = 0; i < graph.length; i++) {
                ...
                return mapping.findForward("eventsTypeWiseTabular");
                 }
                ...
                ArrayList eventType = remote.getEventsConductedAreaWiseSpecificEventType(startDate, endDate, eventTypeId);
                /*for(int i=0;i<eventType.size();i++)
                {
                HashMap typeWise=(HashMap)eventType.get(i);
                Set type=typeWise.keySet();
                for(Iterator it=type.iterator();it.hasNext();)
                {
                ...
                request.setAttribute("title", "Number of Events Conducted Area Wise For " + eventTypeName + " Event Type");
                 request.setAttribute("graphsCount",graphNew);
                return mapping.findForward("eventsAreaWiseForEventType");
                    }
                else
                {
                      List list = new ArrayList();
                ...
                String graphNew = request.getParameter("graph");
                String graph[] = graphNew.split(",");
                Double count = remote.getHumanMembersParticipatedInEvents(startDate, endDate);
                if (view.equalsIgnoreCase("1")) {
                    for (int i = 0; i < graph.length; i++) {
                ...
                return mapping.findForward("humanMembersParticipatedInEvents");
                }
                else
                {
                     List list = new ArrayList();
                     ...
                     return mapping.findForward("humanMembersParticipatedInEventsTabular");
                }
                ...
                String graphNew = request.getParameter("graph");
                String graph[] = graphNew.split(",");
                ArrayList count = remote.getHumanMemeberParticipatedAreaWise(startDate, endDate);
                // PLot Format Chart Generation
                ...
                else
                {
                   ...
                   return mapping.findForward("eventsAreaWiseForEventTypeTabular");
                ...
                if (process.equalsIgnoreCase("humanMembersParticipatedForAllHumanMemberships")) {
                    humanCount = remote.getHumanMembersParticipatedForAllHumanMemberships(startDate, endDate);
                } else if (process.equalsIgnoreCase("getHumanMembersParticipatedEventTypeWise")) {
                    humanCount = remote.getHumanMembersParticipatedEventTypeWise(startDate, endDate);
                }
                 if (view.equalsIgnoreCase("1")) {
                    for (int i = 0; i < graph.length; i++) {
                ...
                return mapping.findForward("eventsAreaWiseForEventType");
                 ...
                 else
                 {
                    ...
                    return mapping.findForward("getHumanMembersParticipatedEventTypeWiseTabular");
                } else {
                    session.setAttribute("reportTitle", "Number of Human Members Participated in Events For All Memberships");
                    return mapping.findForward("getHumanMembersParticipatedMembershipsWiseTabular");
                }
                ...
                ArrayList mambership = remote.getHumanMemberParticipatedMembeAreaWise(startDate, endDate, areaId);
