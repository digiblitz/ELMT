 ...
 * @version
 */
public class AddPriceAction extends Action {
            ...
            if(cmd!=null){
                if(cmd.equals("initPrice")){
                    ...
                    if(newItem!=null){
                        ...
                        if(isExist==true){
                            ...
                            return mapping.findForward("frmOEENewItemCreate");
                        }else{
                            itemId=qremote.insertNewPriceItem(itemName,"true");
                        }
                        //for new item
                        request.setAttribute("eventId","eventId");
                    ...
                    itemDetails = qremote.getAllItemNamesForOrg();
                    //eventType = qremote.getEventTypeDetWithoutChamp(eventId);
                    //Debug.print("eventType in AddPriceAction servlet:initPrice "+eventType.size());
                    //eventTypeChamp = qremote.getEventTypeDetailsForChamp(eventId);
                    //Debug.print("eventType in AddPriceAction servlet:initPrice "+eventTypeChamp.size());
                    eventLevel = qremote.getEventLevelDetWithoutChamp(eventId);
                    Debug.print("eventLevel in AddPriceAction servlet: initPrice"+eventLevel.size());
                    eventLevelChamp = qremote.getEventLevelDetWithChamp(eventId);
                    ...
                    return mapping.findForward("frmOEEInsertPriceDetails");
                }
                ...
                if(cmd.equals("insertPriceDetails")){
                    ...
                    for(int i=1; i<=noChampSize; i++){
                       ...
                       Debug.print("eventTypeId AddPriceAction: "+eventTypeId);
                        ...
                        //if(duePrice!=null && duePrice.trim().length()!=0 && afterDuePrice!=null && afterDuePrice.trim().length()!=0){
                            ...
                            isexist=qremote.isPriceMatrixExist(eventId,itemId,eventTypeId,eventLevelId);
                            if(isexist==true){
                                request.setAttribute("AlreadyExist","AlreadyExist");
                                request.setAttribute("eventId",eventId);
                                request.setAttribute("itemId",itemId);
                                request.setAttribute("itemDetails",itemDetails);
                                return mapping.findForward("frmOEEPriceDetailsSuccess");
                            }else{
                                noChampResult=qremote.insertPriceMatrixDetails(priceVO);
                            }
                 ...
                 //if(CduePrice!=null && CduePrice.trim().length()!=0 && CafterDuePrice!=null && CafterDuePrice.trim().length()!=0){
                            ...
                            boolean noChampResult=false;
                            boolean isexist=false;
                            isexist=qremote.isPriceMatrixExist(eventId,itemId,CeventType,CeventLevel);
                            if(isexist==true){
                ...
                if(cmd.equals("initViewPrice")){
                    ...
                    request.setAttribute("itemDetails",itemDetails);
                    request.setAttribute("eventId",eventId);
                    return mapping.findForward("frmOEEViewPriceDetails");
                }
                if(cmd.equals("viewPrice")){
                    ...
                    eventType = qremote.getEventTypeDetailsByItemId(eventId,itemId);
                    eventTypeChamp = qremote.getEventTypeDetByItemIdForChamp(eventId,itemId);
                    itemDetails = qremote.getAllItemNamesForOrg();
                    eventDetails = qremote.getPriceMatrixDetails(eventId,itemId);
                    champDetails=qremote.getPriceMatrixDetailsForChamp(eventId,itemId);
                ...
                if(cmd.equals("initOrgView")){
                    ...
                    return mapping.findForward("frmOEEOrgViewPriceDetails");
                }
                ...
                if(cmd.equals("initOrgEditPrice")){
                    ...
                    return mapping.findForward("frmOEEOrgEditPriceDetails");
                }
                if(cmd.equals("initEditPriceDetails")){
                    ...
                    return mapping.findForward("frmOEEEditPriceDetails");
                }
                if(cmd.equals("updatePriceByOrg")){
                    ...
                    for(int i=1; i<=noChampSize; i++){
                       ...
                       //if(duePrice!=null && duePrice.trim().length()!=0 && afterDuePrice!=null && afterDuePrice.trim().length()!=0
                            ...
                            boolean noChampResult=false;
                            noChampResult=qremote.updatePriceMatrixDetails(priceVO);
                            if(noChampResult==true){
                                flag=true;
                            }else{
                                flag=false;
                    ...
                    if(flag==true){
                        ...
                        return mapping.findForward("frmOEEPriceEditSuccess");
                    }else{
                        request.setAttribute("itemDetails",itemDetails);
                        request.setAttribute("eventId",eventId);
                ...
                if(cmd.equals("updatePriceDetails")){
                    ...
                    if(flag==true){
                        request.setAttribute("itemDetails",itemDetails);
                        request.setAttribute("updateStatus","success");
                        return mapping.findForward("frmOEEPriceACEditSuccess");
                    }else{
                        request.setAttribute("itemDetails",itemDetails);
                        request.setAttribute("updateStatus","failed");
                        return mapping.findForward("frmOEEPriceACEditSuccess");
